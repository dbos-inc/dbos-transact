...
export function registerAndWrapFunction<This, Args extends unknown[], Return>(
  target: object,
  propertyKey: string,
  descriptor: TypedPropertyDescriptor<(this: This, ...args: Args) => Promise<Return>>
) {
...
export function associateClassWithEventReceiver<CT extends { new (...args: unknown[]): object }>(rcvr: DBOSEventReceiver, ctor: CT) {
